from cleaning_data_outliers import fall_excluded_dataset, new_dataset2, new_dataset3, new_dataset4
...
fall_sites = set(fall_overlapping_sites_list)
spring_sites = set(spring_overlapping_sites_list)
common_sites = fall_sites.intersection(spring_sites)
print(f"Common overlapping sites:")
